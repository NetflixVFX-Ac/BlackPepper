...
def set_mantra_fx_for_comp(hip_path, output_path, abc_path, cam_node):
    ...
    temp_path = os.path.join(home_path + '/temp_exr', basename)
    if not os.path.isdir(home_path + '/temp_exr'):
        os.makedirs(home_path + '/temp_exr')
    ...
    if root is not None:
        ...
        print("Hqueue Submit Job exr complete")
    ...
    #     if len(error_list) == 0:
    #         shutil.rmtree(home_path + '/temp_exr')
    #     else:
    #         print("exr.mantra_checkpoint exists")
    # else:
    #     print("missing sequence frame")

    # saved_path = '/home/rapa/sw_hq_test_exr.hiplc'
