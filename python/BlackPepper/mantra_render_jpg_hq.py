...
def set_mantra_for_preview(hip_path, output_path, abc_path, cam_node):
    ...
    temp_path = os.path.join(home_path + '/temp_jpg', basename)
    if not os.path.isdir(home_path + '/temp_jpg'):
        os.makedirs(home_path + '/temp_jpg')
    ...
    if root is not None:
        ...
        print("Hqueue Submit Job jpg complete")
    ...
    # saved_path = '/home/rapa/sw_hq_test_jpg.hiplc'
