"""
*** What is BlackPepper ? ***
    > 이 모듈은 kitsu의 BlackPepper rest full API(Gazu)를 활용하여 \n
...
*** How to use BlackPepper ? ***
    *Login
        먼저 호스트를 지정해주고, identify와 password 를 이용해 로그인한다. \n
        ex) self.BlackPepper = Houpub() \n
        self.BlackPepper.login("http://192.168.3.116/api", "pipeline@rapa.org", "netflixacademy") \n
